...
public class LobbyClient : NetworkBehaviour   // Look into registering the client correctly
{
    ...
    public override void OnStartClient()
    {
        ...
        if (IsOwner) SetNickname(ChooseRandomNickname());
    }

    string ChooseRandomNickname()
    {
        string[] random_nickname = {"Igors", "Eli", "Chloe", "Stan", "Joel", "Rajat", "Franek" };
        int random_nr = Random.Range(0, random_nickname.Length);
